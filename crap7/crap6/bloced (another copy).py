...
#TODO put selection creation to separate method and use to implement select_all
...
class BlockEditorWindow :
	...
	def close_window(self, a=None) :
		if self.file_changed :
			ans = tkMessageBox.askquestion(type=tkMessageBox.YESNOCANCEL,
