...
#XXX		self.__changed("meta_changed", self.get_meta())
	...
	def build_job(self, w_data, term_stream, cache) :
		...
		rc, blob, probes = chain.build_workbench(w_data, term_stream, cache,
			blockfactory, msgq, all_in_one_arduino_dir)
